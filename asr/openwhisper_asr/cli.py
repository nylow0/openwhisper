...
def build_parser() -> argparse.ArgumentParser:
    ...
    record_parser.add_argument("--model", default="medium_en_q8", help="Model key or alias: base, medium, turbo")
    ...
    transcribe_parser.add_argument("--model", default="medium_en_q8", help="Model key or alias: base, medium, turbo")
